...
public class AIChatPrompts {
    ...
    /**
     * Generates a system prompt with information about love types and emotional states
    ...
    public ExtractionResult extractContext(List<ChatMessage> conversationHistory, 
        ...
        // This is a simplified condition - you might want to make this more sophisticated
