...
CREATE TABLE IF NOT EXISTS love_types (
    id integer NOT NULL,
    created_at timestamptz NOT NULL,
    updated_at timestamptz NOT NULL,
...
CREATE TABLE IF NOT EXISTS ritual_pack_rituals (
    pack_id uuid NOT NULL,
    ritual_id uuid NOT NULL
);

CREATE TABLE IF NOT EXISTS ritual_packs (
    created_at timestamptz NOT NULL,
    updated_at timestamptz NOT NULL,
    id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS ritual_recommendations (
    created_at timestamptz NOT NULL,
    id uuid NOT NULL,
